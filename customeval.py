...
def unsupervised_denoise(data_dir, output_dir, mdpt, cuda, patch_size, patch_overlap, normalize_over):
	...
	for image in images:
		...
		out_path = Path(output_dir, f"CL_{normalize_over}_{patch_size}_{image.name}")
